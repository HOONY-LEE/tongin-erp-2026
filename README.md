...
- **구현 시작**: Phase 0 진행 중 — **FND-01·02·04 완료** (build/lint/typecheck/format 통과)
- **AI 개방 계층(AX) 설계 추가**: 에이전트=RBAC 1급 주체 + 이벤트 디스패치 + 선언적 워크플로우 ([설계노트 1-B](통인익스프레스-ERP-설계노트.md)). 원칙은 FND-03·07에 선반영, 구현은 P2~3(AIX/AUTO).
- **다음 액션**: FND-03(인증·RBAC + 에이전트 주체)·FND-05~09(마스터) → Phase 1(MVP)
